...
CAM_FRAME_OPTICAL = 'openni_rgb_optical_frame'
...
class LookAtHumanActionServer(object):
    ...
    def __init__(self, name):
        ...
        self._as = actionlib.SimpleActionServer(self._action_name, LookAtHumanAction, execute_cb=self.execute_cb, auto_start=False)
